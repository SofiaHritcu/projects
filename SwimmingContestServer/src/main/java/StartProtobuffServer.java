...
import swimmingContest.network.utils.SwimmingContestProtobuffConcurrentServer;
...
public class StartProtobuffServer {
    ...
    public static void main(String[] args) {
        ...
        AbstractServer server = new SwimmingContestProtobuffConcurrentServer(swimmingContestServerPort, swimmingContestServerImpl) {
        };
        try {
            server.start();
