...
public interface ISwimmingContestServices {
    ...
    Participant findParticipant(Participant toBeChecked) throws SwimmingContestException;
    ...
    SwimmingEvent findSwimmingEventByStrokeDistance(SwimmingEvent toBeChecked) throws SwimmingContestException;
